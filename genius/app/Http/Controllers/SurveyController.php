...
class SurveyController extends Controller
{
    ...
    {   
        ...
        if ($regionType == "city" && $timeType == "day") {
            ...
            if ($baseStationStr) {
                $sql = "select timeStamp,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp <='$endTime' and timeStamp>='$startTime' and userLabel in $baseStation group BY timeStamp";
            } else {
                $sql = "select timeStamp,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp >='$startTime' and timeStamp<='$endTime' group BY timeStamp";
            }
            $res = $db->query("select count(*) from ($sql) as total");
            $total = $res->fetchAll(PDO::FETCH_NUM)[0];
            $result['total'] = $total;
            ...
            if ($res) {
                ...
                foreach ($rows as $row) {
                    ...
                    $temp = array_merge(array("id" => $id++,"cellTotal"=>$row[$sum_num+1], "city" => $city, "date" => $timeStamp,"baseStationGroup"=>'baseStationGroup'), $temp);
            ...
            $sql = "select timeStamp,hourId,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp >='$startTime' and timeStamp<='$endTime' ".$filter." group BY timeStamp,hourId";
            $res = $db->query("select count(*) from ($sql) as total");
            $total = $res->fetchAll(PDO::FETCH_NUM)[0];
            $result['total'] = $total;
            ...
            if ($res) {
                ...
                foreach ($rows as $row) {
                    ...
                    $temp = array_merge(array("id" => $id++,"cellTotal"=>$row[$sum_num+2], "city" => $city, "date" => $timeStamp, "hourId" => $hourId,"baseStationGroup"=>'baseStationGroup' ), $temp);
    ...
    {   
        ...
        if ($regionType == "city" && $timeType == "day") {
            ...
            if ($baseStationStr) {
                $sql = "select timeStamp,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp >='$startTime' and timeStamp<='$endTime' and userLabel in $baseStation group BY timeStamp order by timeStamp";
            } else {
                $sql = "select timeStamp,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp <='$endTime' and timeStamp>='$startTime' group BY timeStamp order by timeStamp";
            }
            $res = $db->query($sql);
            if ($res) {
                $rows = $res->fetchAll(PDO::FETCH_NUM);
                ...
                foreach ($rows as $row) {
                    ...
                    $temp = array_merge(array("date" => $timeStamp,"cellTotal"=>$row[$sum_num+1], "city" => $city, "baseStationGroup"=>'baseStationGroup'), $temp);
            ...
            $sql = "select timeStamp,hourId,$searchArr,count(distinct ecgi) as count_ecgi from $table where timeStamp <='$endTime' and timeStamp >= '$startTime' ".$filter." group BY timeStamp,hourId order by timeStamp,hourId";
            $res = $db->query($sql);
            if ($res) {
                $rows = $res->fetchAll(PDO::FETCH_NUM);
                $city = $dbc->getPGToCHName($city);
                foreach ($rows as $row) {
                    ...
                    $temp = array_merge(array("date" => $timeStamp, "hourId" => $hourId,"cellTotal"=>$row[$sum_num+2], "city" => $city,"baseStationGroup"=>'baseStationGroup'), $temp);
